...
@testset "Deconstruct Latent Variables Tests" begin include("deconstruct_latent_variables_tests.jl") end
...
@testset "Analysis Tests" begin include("analysis_tests.jl") end
@testset "Cost Function Tests" begin include("cost_functions_tests.jl") end
@testset "Cost Function: Homography Matrix Tests" begin include("cost_homography_tests.jl") end
